...
<span class="glyphicon glyphicon-envelope"></span>  salemaster@gmail.com,    
...
<a class="navbar-brand" href="#" style="color:#17A589">Sale Master</a>
...
<div class="row" >
    <div >
    <h1 align="center">Welcome to Sale Master</h1>
...
<table style="width: 100%; border-spacing: 10px; " border="1px solid black">
    <thead>
    <th style="font-size: 40px; align: center" >
        Happy Customers
    </th>
    </thead>
    <tr>
        <td><img src="images/hc1.jpg" alt="" style="width:100%; height:350px;"></td>
...
<table style="width: 100%; border-spacing: 10px; " border="1px solid black">
    <tr>
        <td><img src="images/hc2.jpg" alt="" style="width:100%; height:350px;"></td>
...
<footer class="container-fluid text-center" >
  <h4><i><b>Online Buy & Sale cars</b></i></h4>  
...
<div class="container-fluid footer" style="background-color:#33d6ff;">
<div class="container-fluid">
<div class="col-sm-4">
...
<p>Email : </strong> Salemaster@gmail.com</p>
