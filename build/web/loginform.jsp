...
<script>
    function al(form) {
if (form.cont.value=="kasimsiddiqui123@gmail.com") { 
if (form.apass.value=="Kasim Siddiqui#123@") {              
location="admin.jsp" 
} else {
      swal(
      'Error!',
...
<li id="hi4"><a href="#" ><span class="glyphicon glyphicon-user"></span> Kasim Siddiqui</a></li>
